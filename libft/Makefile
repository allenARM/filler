...
#    Updated: 2018/12/04 15:00:00 by amelikia         ###   ########.fr        #
#                                                                              #
# **************************************************************************** #
...
$(NAME):
	gcc $(CFLAGS) -I$(HEADER) -c $(CFILES) $(PRINTF_CFILES)
	ar rc $(NAME) $(OFILES) $(PRINTF_OFILES)
	ranlib $(NAME)

clean:
	/bin/rm -f $(OFILES)
	/bin/rm -f $(PRINTF_OFILES)
